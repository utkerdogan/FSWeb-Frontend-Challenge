export function Footer(){
    ...
    <footer className="w-full bg-gray-100 text-center py-10 pt-16 dark:bg-gray-800">
        <h2 className="text-3xl font-bold text-blue-800 dark:text-purple-900">Send me a message!</h2>
        <p className="text-gray-700 mt-4 dark:text-white">Got a question? Go ahead and send me a message!</p>
